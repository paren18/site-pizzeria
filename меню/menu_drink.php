...
<body>
   <script src="photo.js"></script>
    ...
    <div id="message"></div>
    <?php
    $result = mysqli_query($mysql, "SELECT * FROM `bluda` WHERE `tip_bluda`='Напитки'");
    ...
    foreach ($result as $bluda) {
        ...
        ?>
    <td class="border border-dark"><a href="../фото/Напитки/<?php echo $bluda["photo"]?>" data-lightbox="images"><img src="../фото/Напитки/<?php echo $bluda["photo"]?>" width="245"></a></td>
    <?php
  ...
  <td class=" border-dark bg-secondary bg-gradient fw-bold">
    <div class="product-details">
      ...
      <input type="hidden" class="photo" value="../фото/Напитки/<?= $bluda['photo'] ?>">
